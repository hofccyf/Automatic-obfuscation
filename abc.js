const FIXED_UUID = '58889888-8888-8888-8888-588898885888';// 建议修改为自己的规范化UUID，如不需要可留空
let 反代IP = 'usip.88888888.xx.kg', 启用SOCKS5反代 = null, 启用SOCKS5全局反代 = false, 我的SOCKS5账号 = '', parsedSocks5Address = {};
export default {
    async fetch(request) {
        try {
